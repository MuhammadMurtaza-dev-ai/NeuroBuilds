  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-20">
        ...
        <div className="col-span-1 md:col-span-4 flex flex-col gap-6">
          <div className="glass-panel rounded-bento p-6 flex-1 flex flex-col justify-center border-l-4 border-l-primary hover:bg-white/5 transition-colors">
            <div className="flex justify-between items-start mb-2">
              <p className="text-gray-400 text-sm font-medium uppercase tracking-wider">Active Builds</p>
              <span className="material-symbols-outlined text-primary">developer_board</span>
            </div>
            <p className="text-4xl font-bold text-white tracking-tighter">1,248</p>
            <p className="text-primary text-sm font-mono mt-1">&gt; +12% this week</p>
          </div>
          <div className="glass-panel rounded-bento p-6 flex-1 flex flex-col justify-center border-l-4 border-l-accent-purple hover:bg-white/5 transition-colors">
            <div className="flex justify-between items-start mb-2">
              <p className="text-gray-400 text-sm font-medium uppercase tracking-wider">Market Vol.</p>
            ...
            <p className="text-accent-purple text-sm font-mono mt-1">&gt; Updated 4ms ago</p>
          </div>
        </div>
        ...
        <div className="col-span-1 md:col-span-7 glass-panel rounded-bento p-8 flex flex-col relative overflow-hidden">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-xs text-primary font-mono hover:underline">VIEW LOGS</button>
          </div>
          <div className="flex flex-col gap-3 font-mono text-sm overflow-y-auto max-h-[200px] pr-2">
            <div className="flex gap-4 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-white/5 items-center group cursor-pointer">
              ...
              <span className="material-symbols-outlined text-gray-600 group-hover:text-primary ml-auto text-sm">
                arrow_forward
              </span>
            </div>
            <div className="flex gap-4 p-3 rounded-xl bg-white/5 hover:bg-white/10 transition-colors border border-white/5 items-center group cursor-pointer">
      ...
      <section className="mb-20">
        <div className="flex items-center justify-between mb-8 px-4">
          ...
          <div className="flex gap-2">
            <button className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/10 hover:border-primary/50 text-white transition-all">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="glass-panel rounded-full px-8 py-6 flex items-center justify-between group cursor-pointer hover:border-primary/30 transition-all">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Get weekly hardware updates</p>
            </div>
          </div>
        ...
        <div className="glass-panel rounded-full px-8 py-6 flex items-center justify-between group cursor-pointer hover:border-accent-purple/30 transition-all">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Connect with 10K+ builders</p>
            </div>
          </div>
